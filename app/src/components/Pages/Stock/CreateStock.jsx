...
function CreateStock() {
  ...
  const addProduct = async (event) => {
    ...
    const response = await executeTransaction(
      ...
      provider,
      "addProduct",
      [productName, model, dealer, serialNumber, warranty],
      0
    );
  ...
  useEffect(() => {
    const fetchdata = async () => {
      ...
      setIsWarrantyDisabled(false); // enable warranty input field
    };
    fetchdata();
  }, []);
    ...
    <div>
      ...
      <div className="contstock">
        ...
        <form className="login-form" onSubmit={addProduct}>
          {/* <div className="d0d1" name="productName"> */}
          ...
          {/* <div className="d0d1" name="model" value={models}> */}
          <Dropdown className="dp">
            <Dropdown.Toggle
              id="dropdown-button-dark-example1"
              variant="secondary"
          ...
          {/* <div className="d0d1" name="dealer"> */}
          <label className="modlabel" htmlfor="text">
            Dealer
          </label>
          <Dropdown className="dp">
          ...
          <input
            id="warranty"
            className="inputfield"
            placeholder="Warranty File"
            type="text"
            ref={warrantyRef}
            value={selectedModel ? selectedModel.warranty : ""}
          ...
          {/* <div className="btndiv">
            <button style={{ backgroundColor: "BLUE" }} className="btn1">
              Add a Stock
            </button>
          </div> */}
